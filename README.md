...
[![Awesome DevOps](http://awesome-devops.xyz/assets/banner.png)](https://github.com/wmariuss/awesome-devops) ⭐ 4,380 | 🐛 176 | 🌐 Python | 📅 2026-09-20

[![Deploy](https://github.com/wmariuss/awesome-devops/actions/workflows/deploy.yml/badge.svg)](https://github.com/wmariuss/awesome-devops/actions/workflows/deploy.yml) ⭐ 4,380 | 🐛 176 | 🌐 Python | 📅 2026-09-20
[![Links validator](https://github.com/wmariuss/awesome-devops/actions/workflows/links-validator.yml/badge.svg)](https://github.com/wmariuss/awesome-devops/actions/workflows/links-validator.yml) ⭐ 4,380 | 🐛 176 | 🌐 Python | 📅 2026-09-20
...
* [Fakecloud](https://github.com/faiscadev/fakecloud) ⭐ 553 | 🐛 3 | 🌐 Rust | 📅 2026-09-16 - Free, open-source local AWS cloud emulator for development and testing.
...
* [Photon](https://github.com/vmware/photon) ⭐ 3,178 | 🐛 248 | 🌐 C | 📅 2026-09-19 - Linux container host optimized for cloud-native applications, cloud platforms, and VMware infrastructure.
...
* [Docker Compose](https://github.com/docker/compose) ⭐ 38,200 | 🐛 107 | 🌐 Go | 📅 2026-09-18 - Define and run multi-container applications with Docker.
* [Podman](https://github.com/containers/podman) ⭐ 32,902 | 🐛 1,033 | 🌐 Go | 📅 2026-09-19 - A tool for managing OCI containers and pods.
* [Piku](https://github.com/piku/piku) ⭐ 6,605 | 🐛 6 | 🌐 Python | 📅 2026-09-04 - The tiniest PaaS you've ever seen. Piku allows you to do git push deployments to your own servers.
...
* [Dockyard](https://github.com/Huawei/dockyard) ⭐ 278 | 🐛 12 | 🌐 Go | 📅 2023-04-12 - Container & Artifact Repository.
...
* [OctoDNS](https://github.com/github/octodns) ⭐ 3,761 | 🐛 3 | 🌐 Python | 📅 2026-09-09 - Managing DNS across multiple providers. DNS as code.
...
* [pyenv](https://github.com/pyenv/pyenv) ⭐ 45,103 | 🐛 55 | 🌐 Shell | 📅 2026-09-17 - Simple Python version management.
* [tfenv](https://github.com/tfutils/tfenv) ⭐ 4,970 | 🐛 34 | 🌐 Shell | 📅 2026-07-01 - Terraform version manager.
* [kubefwd](https://github.com/txn2/kubefwd) ⭐ 4,170 | 🐛 10 | 🌐 Go | 📅 2026-09-15 - Bulk port forwarding Kubernetes services for local development.
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,438 | 🐛 46 | 🌐 Go | 📅 2026-09-01 - streamline IaC version manager for OpenTofu, Terraform, Terragrunt and Atmos, written in Go.
* [purple](https://github.com/erickochen/purple) ⭐ 699 | 🐛 5 | 🌐 Rust | 📅 2026-09-17 - SSH client with AWS/GCP/Azure sync, Docker/Podman and SCP transfers.
* [Telert](https://github.com/navig-me/telert) ⭐ 288 | 🐛 8 | 🌐 Python | 📅 2026-08-07 - Get alerts when terminal commands finish via Telegram, Slack, Audio, etc.
* [claws](https://github.com/clawscli/claws) ⭐ 158 | 🐛 6 | 🌐 Go | 📅 2026-07-25 - A terminal UI for managing AWS resources across multiple profiles and regions with vim-style navigation.
...
* On-premises
  * [Drone](https://github.com/drone/drone) ⭐ 38,407 | 🐛 111 | 🌐 Go | 📅 2026-09-18 - a Container-Native, Continuous Delivery Platform.
  ...
  * [Flagger](https://github.com/weaveworks/flagger) ⭐ 5,411 | 🐛 389 | 🌐 Go | 📅 2026-09-08 - progressive delivery Kubernetes operator (Canary, A/B Testing and Blue/Green deployments).
  * [Semaphore Community Edition](https://github.com/semaphoreio/semaphore) ⭐ 1,604 | 🐛 174 | 🌐 Elixir | 📅 2026-09-18 - open-source (Apache-2) CI/CD for building, testing, and deploying any project.
  * [Evergreen](https://github.com/evergreen-ci/evergreen) ⭐ 449 | 🐛 21 | 🌐 Go | 📅 2026-09-18 - A Distributed Continuous Integration System from MongoDB.
...
* [Phabricator](https://github.com/phacility/phabricator/) ⭐ 12,293 | 🐛 3 | 🌐 PHP | 📅 2024-04-12 - A collection of web applications which help software companies build better software.
* [Gitblit](https://github.com/gitblit/gitblit) ⭐ 2,360 | 🐛 254 | 🌐 Java | 📅 2025-06-14 - Pure Java Git solution for managing, viewing, and serving Git repositories.
...
* [Uwsgi](https://github.com/unbit/uwsgi/) ⭐ 3,544 | 🐛 897 | 🌐 C | 📅 2025-10-11 - Application server container.

## SSL

*Tools for automating the management of SSL certificates.*

* [Certbot](https://github.com/certbot/certbot) ⭐ 33,243 | 🐛 176 | 🌐 Python | 📅 2026-09-15 - Automate using Let’s Encrypt certificates on manually-managed websites to enable HTTPS.
* [Cert Manager](https://github.com/jetstack/cert-manager) ⭐ 14,083 | 🐛 258 | 🌐 Go | 📅 2026-09-20 - K8S add-on to automate the management and issuance of TLS certificates from various issuing sources.
...
* Non-relational (NoSQL)
  ...
  * [Rethinkdb](https://github.com/rethinkdb/rethinkdb) ⭐ 26,997 | 🐛 1,352 | 🌐 C++ | 📅 2026-03-28 - Open-source database for the real-time web.
  * Key-Value
    ...
    * [Leveldb](https://github.com/google/leveldb) ⭐ 39,431 | 🐛 409 | 🌐 C++ | 📅 2026-03-11 - Fast key-value storage library.
    ...
    * [Etcd](https://github.com/etcd-io/etcd) ⭐ 52,282 | 🐛 353 | 🌐 Go | 📅 2026-09-20 - Distributed reliable key-value store for the most critical data of a distributed system.

## Observability & Monitoring

*Observability, Monitoring, Metrics/Metrics collection and Alerting tools.*

* [Glances](https://github.com/nicolargo/glances) ⭐ 33,626 | 🐛 103 | 🌐 Python | 📅 2026-09-20 - Monitoring information through a curses or Web based interface.
* [cAdvisor](https://github.com/google/cadvisor) ⭐ 19,438 | 🐛 65 | 🌐 Go | 📅 2026-09-18 - Analyzes resource usage and performance characteristics of running containers.
* [Keep](https://github.com/keephq/keep) ⭐ 12,336 | 🐛 621 | 🌐 Python | 📅 2026-09-19 - Open source alerting CLI for developers.
* [Healthchecks](https://github.com/healthchecks/healthchecks) ⭐ 10,347 | 🐛 53 | 🌐 Python | 📅 2026-09-14 - Cron monitoring tool.
* [Cabot](https://github.com/arachnys/cabot) ⭐ 5,677 | 🐛 166 | 🌐 JavaScript | 📅 2023-09-10 - Self-hosted, easily-deployable monitoring and alerts service.
* [HolmesGPT](https://github.com/robusta-dev/holmesgpt) ⭐ 3,421 | 🐛 434 | 🌐 Python | 📅 2026-09-20 - Open Source AI assistant that can investigate alerts and find root cause automatically.
* [Alerta](https://github.com/alerta/alerta) ⭐ 2,528 | 🐛 34 | 🌐 Python | 📅 2026-06-19 - Scalable, minimal configuration and visualization monitoring system.
...
* [Grai](https://github.com/grai-io/grai-core) ⭐ 317 | 🐛 51 | 🌐 Python | 📅 2026-01-30 - Open source observability integrating data impact analysis into CI.
* [Globalping CLI](https://github.com/jsdelivr/globalping-cli) ⭐ 285 | 🐛 2 | 🌐 Go | 📅 2026-09-17 - Run network commands like ping, traceroute and mtr from hundreds of global locations.
...
* Metrics/Metrics collection
  ...
  * [Collectd](https://github.com/collectd/collectd) ⭐ 3,364 | 🐛 790 | 🌐 C | 📅 2026-05-29 - The system statistics collection daemon.
...
* Logs Management
  * [Loki](https://github.com/grafana/loki) ⭐ 28,917 | 🐛 1,529 | 🌐 Go | 📅 2026-09-20 - Horizontally-scalable, highly available, multi-tenant log aggregation system inspired by Prometheus.
  * [Graylog](https://github.com/Graylog2/graylog2-server) ⭐ 8,138 | 🐛 2,085 | 🌐 Java | 📅 2026-09-18 - Free and open source log management.
...
* Status
  * [Cachet](https://github.com/CachetHQ/Cachet) ⭐ 15,246 | 🐛 6 | 🌐 PHP | 📅 2026-09-17 - Beautiful and powerful open-source status page system.
  * [Oxmgr](https://github.com/Vladimir-Urik/OxMgr) ⭐ 256 | 🐛 19 | 🌐 Rust | 📅 2026-09-17 - Lightweight Rust process manager and PM2 alternative. 42x faster crash recovery, 19x lower memory usage. Manages Node.js, Python, Go, and any executable on Linux, macOS, and Windows.
...
* [Linkerd](https://github.com/linkerd/linkerd2) ⭐ 11,497 | 🐛 225 | 🌐 Go | 📅 2026-09-20 - Service mesh for Kubernetes and beyond.
...
* [Chaos Monkey](https://github.com/Netflix/chaosmonkey) ⭐ 17,139 | 🐛 34 | 🌐 Go | 📅 2025-01-06 - A resiliency tool that helps applications tolerate random instance failures.
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,353 | 🐛 105 | 🌐 Go | 📅 2026-09-15 - Simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,908 | 🐛 546 | 🌐 Go | 📅 2026-09-10 - A Chaos Engineering Platform for Kubernetes.
* [Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,618 | 🐛 392 | 🌐 Go | 📅 2026-09-20 - Litmus enables teams to identify weaknesses in infrastructures.
* [Pumba](https://github.com/alexei-led/pumba) ⭐ 3,170 | 🐛 7 | 🌐 Go | 📅 2026-09-17 - Chaos testing, network emulation and stress testing tool for containers.
...
* [Cilium](https://github.com/cilium/cilium) ⭐ 25,382 | 🐛 1,117 | 🌐 Go | 📅 2026-09-20 - API aware networking and security using BPF and XDP.
* [API Umbrella](https://github.com/NREL/api-umbrella) ⭐ 2,199 | 🐛 256 | 🌐 Ruby | 📅 2026-08-29 - Proxy that sits in front of your APIs, API management platform.
* [Gloo](https://github.com/solo-io/gloo) ⭐ 169 | 🐛 1,867 | 🌐 Go | 📅 2026-09-19 - Feature-rich, Kubernetes-native ingress controller, and next-generation API gateway.
...
* [Faktory](https://github.com/contribsys/faktory) ⭐ 6,147 | 🐛 23 | 🌐 Go | 📅 2026-09-03 - Repository for background jobs within your application.
* [Dkron](https://github.com/distribworks/dkron) ⭐ 4,736 | 🐛 35 | 🌐 Go | 📅 2026-09-20 - Distributed, fault tolerant job scheduling system.
...
* [Infisical](https://github.com/Infisical/infisical) ⭐ 29,339 | 🐛 795 | 🌐 TypeScript | 📅 2026-09-20 - Open source end-to-end encrypted secrets sync for teams and infrastructure.
* [Sops](https://github.com/mozilla/sops) ⭐ 23,171 | 🐛 447 | 🌐 Go | 📅 2026-09-18 - Simple and flexible tool for managing secrets.
* [Git Secret](https://github.com/sobolevn/git-secret) ⭐ 4,045 | 🐛 153 | 🌐 Shell | 📅 2026-08-24 - A bash-tool to store your private data inside a git repository.
* [Vault Secrets Operator](https://github.com/ricoberger/vault-secrets-operator) ⭐ 686 | 🐛 18 | 🌐 Go | 📅 2026-09-02 - Create Kubernetes secrets from Vault for a secure GitOps based workflow.
* [Lade](https://github.com/zifeo/lade) ⭐ 133 | 🐛 1 | 🌐 Rust | 📅 2026-09-18 - Automatically load secrets from your preferred vault as environment variables.
...
* [checkov](https://github.com/bridgecrewio/checkov) ⭐ 9,017 | 🐛 171 | 🌐 Python | 📅 2026-09-17 - Prevent cloud misconfigurations and find vulnerabilities during build-time in infrastructure as code, container images and open source packages.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 955 | 🐛 2 | 🌐 Python | 📅 2026-09-16 - Open source autonomous AI penetration testing platform that orchestrates 80+ offensive tools via Markdown playbooks with a proof trail per finding.
...
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 66,304 | 🐛 400 | 🌐 TypeScript | 📅 2026-09-18 - Easy to maintain open source documentation websites.
* [Docsify](https://github.com/docsifyjs/docsify/) ⭐ 31,521 | 🐛 91 | 🌐 JavaScript | 📅 2026-09-20 - A magical documentation site generator.
* [Gitbook](https://github.com/GitbookIO/gitbook) ⭐ 29,033 | 🐛 103 | 🌐 TypeScript | 📅 2026-09-18 - Modern documentation format and toolchain using Git and Markdown.
...
* [Algo](https://github.com/trailofbits/algo) ⭐ 30,389 | 🐛 77 | 🌐 Python | 📅 2026-09-09 - Set up a personal VPN in the cloud.
* [Streisand](https://github.com/StreisandEffect/streisand) ⚠️ Archived - Sets up a new VPN service nearly automatically.
* [Sshuttle](https://github.com/sshuttle/sshuttle) ⭐ 13,567 | 🐛 211 | 🌐 Python | 📅 2026-09-17 - Transparent proxy server that works as a poor man's VPN.
...
Your contributions are always welcome! Please take a look at the [Contribution Guidelines](https://github.com/wmariuss/awesome-devops/blob/main/docs/contribution.md) ⭐ 4,380 | 🐛 176 | 🌐 Python | 📅 2026-09-20.
