...
* [Docker Compose](https://github.com/docker/compose) ⭐ 38,054 | 🐛 97 | 🌐 Go | 📅 2026-08-24 - Define and run multi-container applications with Docker.
* [Podman](https://github.com/containers/podman) ⭐ 32,678 | 🐛 1,131 | 🌐 Go | 📅 2026-08-24 - A tool for managing OCI containers and pods.
...
* [pyenv](https://github.com/pyenv/pyenv) ⭐ 45,043 | 🐛 57 | 🌐 Shell | 📅 2026-08-16 - Simple Python version management.
...
* [purple](https://github.com/erickochen/purple) ⭐ 653 | 🐛 4 | 🌐 Rust | 📅 2026-08-24 - SSH client with AWS/GCP/Azure sync, Docker/Podman and SCP transfers.
...
* On-premises
  * [Drone](https://github.com/drone/drone) ⭐ 38,105 | 🐛 106 | 🌐 Go | 📅 2026-08-21 - a Container-Native, Continuous Delivery Platform.
  ...
  * [Flagger](https://github.com/weaveworks/flagger) ⭐ 5,394 | 🐛 385 | 🌐 Go | 📅 2026-08-24 - progressive delivery Kubernetes operator (Canary, A/B Testing and Blue/Green deployments).
  * [Semaphore Community Edition](https://github.com/semaphoreio/semaphore) ⭐ 1,582 | 🐛 167 | 🌐 Elixir | 📅 2026-08-24 - open-source (Apache-2) CI/CD for building, testing, and deploying any project.
  * [Evergreen](https://github.com/evergreen-ci/evergreen) ⭐ 450 | 🐛 24 | 🌐 Go | 📅 2026-08-21 - A Distributed Continuous Integration System from MongoDB.
...
* [Certbot](https://github.com/certbot/certbot) ⭐ 33,210 | 🐛 188 | 🌐 Python | 📅 2026-08-21 - Automate using Let’s Encrypt certificates on manually-managed websites to enable HTTPS.
* [Cert Manager](https://github.com/jetstack/cert-manager) ⭐ 14,048 | 🐛 249 | 🌐 Go | 📅 2026-08-22 - K8S add-on to automate the management and issuance of TLS certificates from various issuing sources.
...
* [Glances](https://github.com/nicolargo/glances) ⭐ 33,417 | 🐛 107 | 🌐 Python | 📅 2026-08-23 - Monitoring information through a curses or Web based interface.
* [cAdvisor](https://github.com/google/cadvisor) ⭐ 19,377 | 🐛 63 | 🌐 Go | 📅 2026-07-20 - Analyzes resource usage and performance characteristics of running containers.
* [Keep](https://github.com/keephq/keep) ⭐ 12,240 | 🐛 572 | 🌐 Python | 📅 2026-08-24 - Open source alerting CLI for developers.
* [Healthchecks](https://github.com/healthchecks/healthchecks) ⭐ 10,280 | 🐛 53 | 🌐 Python | 📅 2026-08-21 - Cron monitoring tool.
...
* [HolmesGPT](https://github.com/robusta-dev/holmesgpt) ⭐ 3,131 | 🐛 390 | 🌐 Python | 📅 2026-08-24 - Open Source AI assistant that can investigate alerts and find root cause automatically.
...
* Logs Management
  * [Loki](https://github.com/grafana/loki) ⭐ 28,778 | 🐛 1,727 | 🌐 Go | 📅 2026-08-24 - Horizontally-scalable, highly available, multi-tenant log aggregation system inspired by Prometheus.
  * [Graylog](https://github.com/Graylog2/graylog2-server) ⭐ 8,113 | 🐛 2,045 | 🌐 Java | 📅 2026-08-24 - Free and open source log management.
...
* [Linkerd](https://github.com/linkerd/linkerd2) ⭐ 11,480 | 🐛 207 | 🌐 Go | 📅 2026-08-24 - Service mesh for Kubernetes and beyond.
...
* [Toxiproxy](https://github.com/Shopify/toxiproxy) ⭐ 12,279 | 🐛 105 | 🌐 Go | 📅 2026-08-04 - Simulate network and system conditions for chaos and resiliency testing.
* [Chaos Mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,854 | 🐛 551 | 🌐 Go | 📅 2026-08-18 - A Chaos Engineering Platform for Kubernetes.
...
* [Cilium](https://github.com/cilium/cilium) ⭐ 25,003 | 🐛 1,115 | 🌐 Go | 📅 2026-08-24 - API aware networking and security using BPF and XDP.
...
* [Gloo](https://github.com/solo-io/gloo) ⭐ 170 | 🐛 1,867 | 🌐 Go | 📅 2026-08-21 - Feature-rich, Kubernetes-native ingress controller, and next-generation API gateway.
...
* [Dkron](https://github.com/distribworks/dkron) ⭐ 4,730 | 🐛 36 | 🌐 Go | 📅 2026-08-21 - Distributed, fault tolerant job scheduling system.
...
* [Infisical](https://github.com/Infisical/infisical) ⭐ 28,924 | 🐛 745 | 🌐 TypeScript | 📅 2026-08-24 - Open source end-to-end encrypted secrets sync for teams and infrastructure.
* [Sops](https://github.com/mozilla/sops) ⭐ 22,906 | 🐛 445 | 🌐 Go | 📅 2026-08-24 - Simple and flexible tool for managing secrets.
* [Git Secret](https://github.com/sobolevn/git-secret) ⭐ 4,038 | 🐛 256 | 🌐 Shell | 📅 2026-08-11 - A bash-tool to store your private data inside a git repository.
...
* [checkov](https://github.com/bridgecrewio/checkov) ⭐ 8,971 | 🐛 164 | 🌐 Python | 📅 2026-08-23 - Prevent cloud misconfigurations and find vulnerabilities during build-time in infrastructure as code, container images and open source packages.
...
* [Gitbook](https://github.com/GitbookIO/gitbook) ⭐ 29,005 | 🐛 106 | 🌐 TypeScript | 📅 2026-08-24 - Modern documentation format and toolchain using Git and Markdown.
